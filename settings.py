...
DATABASES = {
    'default': {
        ...
        'NAME': 'halaal_db',       # Matches the name you created in pgAdmin
        'USER': 'postgres',        # The default superuser
        'PASSWORD': 'Uthaimin3636',    # 👈 IMPORTANT: Replace this with the password you set in the installer!
...
# 👇 PASTE THIS AT THE BOTTOM OF core/settings.py
